 ...
 */
class Federal extends \AppBundle\Entity\Federal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'area', 'lat', 'long', 'country'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Federal $proxy) {
    ...
    public function getLong()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLong', []);
    ...
    public function setLong($long)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLong', [$long]);
