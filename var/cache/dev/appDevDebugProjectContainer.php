...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app_bundle.api_doc.fos_rest_form_errors_parser' => 'getAppBundle_ApiDoc_FosRestFormErrorsParserService',
    ...
    /**
     * Gets the 'app_bundle.api_doc.fos_rest_form_errors_parser' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Component\ApiDoc\Parser\FOSRestFormErrorsParser A Component\ApiDoc\Parser\FOSRestFormErrorsParser instance
     */
    protected function getAppBundle_ApiDoc_FosRestFormErrorsParserService()
    {
        return $this->services['app_bundle.api_doc.fos_rest_form_errors_parser'] = new \Component\ApiDoc\Parser\FOSRestFormErrorsParser();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'rating_system', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8bbdc514065a9e14db677be75fb828c6c7013cb366bc3644a31d32e3fc53b1c1');
    ...
    protected function getFosRest_FormatNegotiatorService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'json', 1 => 'xml'), 'fallback_format' => 'json', 'prefer_extension' => false, 'methods' => NULL, 'attributes' => array(), 'stop' => false));
    ...
    protected function getNelmioApiDoc_Extractor_ApiDocExtractorService()
    {
        ...
        $instance->addParser($this->get('app_bundle.api_doc.fos_rest_form_errors_parser'));
    ...
    protected function getNelmioApiDoc_Formatter_HtmlFormatterService()
    {
        ...
        $instance->setEndpoint('http://rest-api.local');
        ...
        $instance->setBodyFormats(array(0 => 'json', 1 => 'xml'));
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.doc' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/documentation'), 'security.firewall.map.context.main' => NULL)), $this->get('debug.event_dispatcher'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58eee110372a11.62570264')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'nelmio_api_doc.sandbox.endpoint' => 'http://rest-api.local',
